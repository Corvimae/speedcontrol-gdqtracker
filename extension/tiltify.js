...
if (nodecg.bundleConfig && nodecg.bundleConfig.enable) {
	...
	needle.get('https://tiltify.com/api/v3/campaigns/'+nodecg.bundleConfig.campaign, requestOptions, (err, resp) => {
